...
public class PlayerCharacter : Character
{
    ...
    protected override void Initiate()
    {
        ...
        fireAction.InitShootingSystem(OnShootAction);
    ...
    public override void Movement()
    {
        ...
        else
        {
            ...
            transform.rotation = Quaternion.Slerp(transform.rotation,serverRotation, movingSpeed * Time.deltaTime);
        }
    }
